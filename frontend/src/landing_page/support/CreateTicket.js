    ...
    <div className="container">
      <div className="row p-5 mb-5 mt-5">
        ...
        <div className="col-4 p-5 mb-2 mt-2">
          <h4 className="mb-5"> <i class="fa fa-plus-circle" aria-hidden="true"></i> Account Opennig</h4>
          ...
          <a href="" style={{textDecoration: "none", lineHeight: "2.5"}}>Charges at TradeVerse</a> <br/>
          <a href="" style={{textDecoration: "none", lineHeight: "2.5"}}>TradeVerse IDFC FIRST Bank 2-in-1 Account</a> <br/>
          <a href="" style={{textDecoration: "none", lineHeight: "2.5"}}>Getting Started</a>

        </div>

        <div className="col-4 pt-5 mb-2 mt-2">
          <h4 className="mb-5"><i class="fa fa-user" aria-hidden="true"></i> Your TradeVerse Account</h4>
        ...
        <div className="col-4 p-5 mb-2 mt-2">
          <h4 className="mb-5"><i class="fa fa-bar-chart" aria-hidden="true"></i> Your TradeVerse Account</h4>

          <a href="" style={{textDecoration: "none", lineHeight: "2.5"}}>Margin/leverage, Product and Order types</a> <br/>
          <a href="" style={{textDecoration: "none", lineHeight: "2.5"}}>Kite Web an Mobile</a> <br/>
